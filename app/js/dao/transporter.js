...
TransporterRPCActions.requestTransporterRPCWithdrawFromMarket.listen(function(
    o
) {
    makeTransporterCall({
...
TransporterRPCActions.requestTransporterRPCGetStoredResources.listen(function(
    o
) {
    makeTransporterCall({
