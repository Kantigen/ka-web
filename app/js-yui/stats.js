    ...
    (function() {
        ...
        Stats.prototype = {
            build: _.once(function() {
                ...
                this.Panel.renderEvent.subscribe(
                    function() {
                        ...
                        this.generalTabView = new YAHOO.widget.TabView(
                            'statsGeneralTabs',
                            { orientation: 'left' }
                        );
                        ...
                        this.statsGeneralBuildings = Dom.get(
                            'statsGeneralBuildings'
                        );
                        this.statsGeneralEmpires = Dom.get(
                            'statsGeneralEmpires'
                        );
                ...
                this.Panel.hideEvent.subscribe(
                    StatsWindowActions.statsWindowHide
                );
            ...
            populateServerStats: function() {
                ...
                Event.delegate(
                    this.statsGeneralBodies,
                    'click',
                    this.expander,
                    'label.statsSubHeader'
                );
                Event.delegate(
                    this.statsGeneralBuildings,
                    'click',
                    this.expander,
                    'label.statsSubHeader'
                );
                Event.delegate(
                    this.statsGeneralOrbits,
                    'click',
                    this.expander,
                    'label.statsSubHeader'
                );
                Event.delegate(
                    this.statsGeneralShips,
                    'click',
                    this.expander,
                    'label.statsSubHeader'
                );
            ...
            expander: function(e, matchedEl, container) {
                ...
                Dom.setStyle(
                    ul,
                    'display',
                    Dom.getStyle(ul, 'display') == 'none' ? '' : 'none'
                );
            },
            _getBodiesHtml: function() {
                ...
                return [
                    '<ul class="statsList">',
                    '<li><label>Total Bodies:</label>',
                    Lib.formatNumber(data.count),
                    '</li>',
                    '<li><label>Colonies:</label>',
                    Lib.formatNumber(data.colony_count),
                    '</li>',
                    ...
                    Lib.formatNumber(data.types.asteroids.count),
                    '</li>',
                    '        <li><label>Average Orbit:</label>',
                    data.types.asteroids.average_orbit,
                    '</li>',
                    '        <li><label>Average Size:</label>',
                    data.types.asteroids.average_size,
                    '</li>',
                    '        <li><label>Largest Size:</label>',
                    data.types.asteroids.largest_size,
                    '</li>',
                    '        <li><label>Smallest Size:</label>',
                    data.types.asteroids.smallest_size,
                    '</li>',
                    '        </ul>',
                    '    </li>',
                    ...
                    '        <ul style="display:none;">',
                    '        <li><label>Total:</label>',
                    Lib.formatNumber(data.types.gas_giants.count),
                    '</li>',
                    '        <li><label>Average Orbit:</label>',
                    data.types.gas_giants.average_orbit,
                    '</li>',
                    '        <li><label>Average Size:</label>',
                    data.types.gas_giants.average_size,
                    '</li>',
                    '        <li><label>Largest Size:</label>',
                    data.types.gas_giants.largest_size,
                    '</li>',
                    '        <li><label>Smallest Size:</label>',
                    data.types.gas_giants.smallest_size,
                    '</li>',
                    '        </ul>',
                    '    </li>',
                    ...
                    '        <ul style="display:none;">',
                    '        <li><label>Total:</label>',
                    Lib.formatNumber(data.types.habitables.count),
                    '</li>',
                    '        <li><label>Average Orbit:</label>',
                    data.types.habitables.average_orbit,
                    '</li>',
                    '        <li><label>Average Size:</label>',
                    data.types.habitables.average_size,
                    '</li>',
                    '        <li><label>Largest Size:</label>',
                    data.types.habitables.largest_size,
                    '</li>',
                    '        <li><label>Smallest Size:</label>',
                    data.types.habitables.smallest_size,
                    '</li>',
                    '        </ul>',
                    '    </li>',
                    ...
                    '        <ul style="display:none;">',
                    '        <li><label>Total:</label>',
                    Lib.formatNumber(data.types.stations.count),
                    '</li>',
                    '        <li><label>Average Orbit:</label>',
                    data.types.stations.average_orbit,
                    '</li>',
                    '        <li><label>Average Size:</label>',
                    data.types.stations.average_size,
                    '</li>',
                    '        <li><label>Largest Size:</label>',
                    data.types.stations.largest_size,
                    '</li>',
                    '        <li><label>Smallest Size:</label>',
                    data.types.stations.smallest_size,
                    '</li>',
                    '        </ul>',
                    '    </li>',
                    '    </ul>',
            ...
            _getBuildingsHtml: function() {
                var data = this._serverOverview.buildings,
                    output = [
                        '<ul class="statsList">',
                        '<li><label>Total Buildings:</label>',
                        Lib.formatNumber(data.count),
                        '</li>',
                ...
                for (var b = 0, bLen = btArr.length; b < bLen; b++) {
                    ...
                    output.push(
                        [
                            '<li><label class="statsSubHeader">',
                            key,
                            '</label>',
                            '    <ul style="display:none;">',
                            '    <li><label>Total:</label>',
                            Lib.formatNumber(data.types[key].count),
                            '</li>',
                            '    <li><label>Average Level:</label>',
                            data.types[key].average_level,
                            '</li>',
                            '    <li><label>Highest Level:</label>',
            ...
            _getEmpiresHtml: function() {
                ...
                return [
                    '<ul class="statsList">',
                    '<li><label>Total Empires:</label>',
                    Lib.formatNumber(data.count),
                    '</li>',
                    '<li><label>Active This Week:</label>',
                    Lib.formatNumber(data.active_this_week_count),
                    '</li>',
                    '<li><label>Active Today:</label>',
                    Lib.formatNumber(data.active_today_count),
                    '</li>',
                    '<li><label>Currently Active:</label>',
                    Lib.formatNumber(data.currently_active_count),
                    '</li>',
                    '<li><label>Average University Level:</label>',
                    Lib.formatNumber(data.average_university_level),
                    '</li>',
                    '<li><label>Highest University Level:</label>',
                    Lib.formatNumber(data.highest_university_level),
                    '</li>',
                    '<li><label>Empires Using Essentia:</label>',
                    Lib.formatNumber(data.essentia_using_count),
                    '</li>',
                    '<li><label>Isolationist Empires:</label>',
                    Lib.formatNumber(data.isolationist_count),
                    '</li>',
                    '</ul>',
                ].join('');
            },
            _getOrbitsHtml: function() {
                ...
                return [
                    ...
                    '    <ul style="display:none;">',
                    '    <li><label>Total Bodies:</label>',
                    Lib.formatNumber(data['1'].bodies),
                    '</li>',
                    '    <li><label>Inhabited:</label>',
                    Lib.formatNumber(data['1'].inhabited),
                    '</li>',
                    '    </ul>',
                    '</li>',
                    ...
                    '    <ul style="display:none;">',
                    '    <li><label>Total Bodies:</label>',
                    Lib.formatNumber(data['2'].bodies),
                    '</li>',
                    '    <li><label>Inhabited:</label>',
                    Lib.formatNumber(data['2'].inhabited),
                    '</li>',
                    '    </ul>',
                    '</li>',
                    ...
                    '    <ul style="display:none;">',
                    '    <li><label>Total Bodies:</label>',
                    Lib.formatNumber(data['3'].bodies),
                    '</li>',
                    '    <li><label>Inhabited:</label>',
                    Lib.formatNumber(data['3'].inhabited),
                    '</li>',
                    '    </ul>',
                    '</li>',
                    ...
                    '    <ul style="display:none;">',
                    '    <li><label>Total Bodies:</label>',
                    Lib.formatNumber(data['4'].bodies),
                    '</li>',
                    '    <li><label>Inhabited:</label>',
                    Lib.formatNumber(data['4'].inhabited),
                    '</li>',
                    '    </ul>',
                    '</li>',
                    ...
                    '    <ul style="display:none;">',
                    '    <li><label>Total Bodies:</label>',
                    Lib.formatNumber(data['5'].bodies),
                    '</li>',
                    '    <li><label>Inhabited:</label>',
                    Lib.formatNumber(data['5'].inhabited),
                    '</li>',
                    '    </ul>',
                    '</li>',
                    ...
                    '    <ul style="display:none;">',
                    '    <li><label>Total Bodies:</label>',
                    Lib.formatNumber(data['6'].bodies),
                    '</li>',
                    '    <li><label>Inhabited:</label>',
                    Lib.formatNumber(data['6'].inhabited),
                    '</li>',
                    '    </ul>',
                    '</li>',
                    ...
                    '    <ul style="display:none;">',
                    '    <li><label>Total Bodies:</label>',
                    Lib.formatNumber(data['7'].bodies),
                    '</li>',
                    '    <li><label>Inhabited:</label>',
                    Lib.formatNumber(data['7'].inhabited),
                    '</li>',
                    '    </ul>',
                    '</li>',
                    ...
                    '    <ul style="display:none;">',
                    '    <li><label>Total Bodies:</label>',
                    Lib.formatNumber(data['8'].bodies),
                    '</li>',
                    '    <li><label>Inhabited:</label>',
                    Lib.formatNumber(data['8'].inhabited),
                    '</li>',
                    '    </ul>',
                    '</li>',
                    '</ul></li></ul>',
                    ...
                    if (data.types.hasOwnProperty(bt)) {
                        output.push(
                            [
                                ...
                                '    <ul style="display:none;">',
                                '    <li><label>Total:</label>',
                                Lib.formatNumber(data.types[bt].count),
                                '</li>',
                                '    <li><label>Smallest Hold Size:</label>',
                                Lib.formatNumber(
                                    data.types[bt].smallest_hold_size
                                ),
                                '</li>',
                                '    <li><label>Average Hold Size:</label>',
                                Lib.formatNumber(
                                    data.types[bt].average_hold_size
                                ),
                                '</li>',
                                '    <li><label>Largest Hold Size:</label>',
                                Lib.formatNumber(
                                    data.types[bt].largest_hold_size
                                ),
                                '</li>',
                                '    <li><label>Slowest Speed:</label>',
                                Lib.formatNumber(data.types[bt].slowest_speed),
                                '</li>',
                                '    <li><label>Average Speed:</label>',
                                Lib.formatNumber(data.types[bt].average_speed),
                                '</li>',
                                '    <li><label>Fastest Speed:</label>',
                                Lib.formatNumber(data.types[bt].fastest_speed),
                                '</li>',
                                '    </ul>',
                                '</li>',
                            ].join('')
            ...
            _getSpiesHtml: function() {
                ...
                return [
                    '<ul class="statsList">',
                    '<li><label>Total Spies:</label>',
                    Lib.formatNumber(data.count),
                    '</li>',
                    '<li><label>Average Defense:</label>',
                    Lib.formatNumber(data.average_defense),
                    '</li>',
                    '<li><label>Highest Defense:</label>',
                    Lib.formatNumber(data.highest_defense),
                    '</li>',
                    '<li><label>Average Offense:</label>',
                    Lib.formatNumber(data.average_offense),
                    '</li>',
                    '<li><label>Highest Offense:</label>',
                    Lib.formatNumber(data.highest_offense),
                    '</li>',
                    '<li><label>Average Intel XP:</label>',
                    Lib.formatNumber(data.average_intel),
                    '</li>',
                    '<li><label>Highest Intel XP:</label>',
                    Lib.formatNumber(data.highest_intel),
                    '</li>',
                    '<li><label>Average Mayhem XP:</label>',
                    Lib.formatNumber(data.average_mayhem),
                    '</li>',
                    '<li><label>Highest Mayhem XP:</label>',
                    Lib.formatNumber(data.highest_mayhem),
                    '</li>',
                    '<li><label>Average Politics XP:</label>',
                    Lib.formatNumber(data.average_politics),
                    '</li>',
                    '<li><label>Highest Politics XP:</label>',
                    Lib.formatNumber(data.highest_politics),
                    '</li>',
                    '<li><label>Average Theft XP:</label>',
                    Lib.formatNumber(data.average_theft),
                    '</li>',
                    '<li><label>Highest Theft XP:</label>',
                    Lib.formatNumber(data.highest_theft),
                    '</li>',
                    '<li><label>Idle:</label>',
                    Lib.formatNumber(data.idle_count),
                    '</li>',
                    '<li><label>Travelling:</label>',
                    Lib.formatNumber(data.travelling_count),
                    '</li>',
                    '<li><label>Countering Espionage:</label>',
                    Lib.formatNumber(data.countering_espionage_count),
                    '</li>',
                    '<li><label>Doing Sweeps:</label>',
                    Lib.formatNumber(data.security_count),
                    '</li>',
                    '<li><label>At the Ministry of Truth:</label>',
                    Lib.formatNumber(data.propaganda_count),
                    '</li>',
                    '<li><label>Training:</label>',
                    Lib.formatNumber(data.training_count),
                    '</li>',
                    '<li><label>Extra Training:</label>',
                    Lib.formatNumber(data.extra_training_count),
                    '</li>',
                    '<li><label>Gathering Intelligence:</label>',
                    Lib.formatNumber(data.gathering_intelligence_count),
                    '</li>',
                    '<li><label>Hacking Networks:</label>',
                    Lib.formatNumber(data.hacking_networks_count),
                    '</li>',
                    '<li><label>Inciting:</label>',
                    Lib.formatNumber(data.inciting_count),
                    '</li>',
                    '<li><label>Sabotaging:</label>',
                    Lib.formatNumber(data.sabotaging_count),
                    '</li>',
                    '<li><label>Appropriating:</label>',
                    Lib.formatNumber(data.stealing_count),
                    '</li>',
                    '<li><label>Extraction:</label>',
                    Lib.formatNumber(data.extraction_count),
                    '</li>',
                    '<li><label>Antipersonal:</label>',
                    Lib.formatNumber(data.antipersonal_count),
                    '</li>',
                    '<li><label>Infiltrating:</label>',
                    Lib.formatNumber(data.infiltrating_count),
                    '</li>',
                    '<li><label>In Prison:</label>',
                    Lib.formatNumber(data.in_prison_count),
                    '</li>',
                    '<li><label>For Sale:</label>',
                    Lib.formatNumber(data.for_sale_count),
                    '</li>',
                    '<li><label>Unconscious:</label>',
                    Lib.formatNumber(data.unconscious_count),
                    '</li>',
                    '</ul>',
                ].join('');
            },
            _getStarsHtml: function() {
                ...
                return [
                    '<ul class="statsList">',
                    '<li><label>Total Stars:</label>',
                    Lib.formatNumber(data.count),
                    '</li>',
                    '<li><label>Seized Stars:</label>',
                    Lib.formatNumber(data.seized_count),
                    '</li>',
                    '<li><label>Probed Stars:</label>',
                    Lib.formatNumber(data.probed_count),
                    '</li>',
                    '<li><label>Total Probes:</label>',
                    Lib.formatNumber(data.probes_count),
                    '</li>',
                    '</ul>',
                ].join('');
            },
                ...
                for (var i = 0; i < glyphs.length; i++) {
                    output.push(
                        [
                            ...
                            glyphs[i].type,
                            ':</label>',
                            Lib.formatNumber(glyphs[i].count),
                            '</li>',
                        ].join('')
                    );
                }
            ...
            EmpireStats: function() {
                if (this.EmpireTable) {
                    ...
                    this.EmpireData = new Util.XHRDataSource(
                        constants.RPC_BASE + 'stats'
                    );
                    this.EmpireData.connMethodPost = 'POST';
                    this.EmpireData.maxCacheEntries = 2;
                    this.EmpireData.responseType =
                    ...
                    this.EmpireTable = new YAHOO.widget.ScrollingDataTable(
                        'statsEmpireTable',
                        this.EmpireColumns,
                        this.EmpireData,
                        {
                    ...
                    this.EmpireTable.subscribe(
                        'rowMouseoverEvent',
                        this.EmpireTable.onEventHighlightRow
                    );
                    this.EmpireTable.subscribe(
                        'rowMouseoutEvent',
                        this.EmpireTable.onEventUnhighlightRow
                    );
                    this.EmpireTable.subscribe(
                        'rowClickEvent',
                        this.EmpireTable.onEventSelectRow
                    );
                    this.EmpireTable.subscribe(
                        'cellMouseoverEvent',
                        this.EmpireTable.onEventHighlightCell
                    );
                    this.EmpireTable.subscribe('cellHighlightEvent', function(
                        oArgs
                    ) {
                        if (
                            oArgs.key == 'empire_name' ||
                            oArgs.key == 'alliance_name'
                        ) {
                    ...
                    this.EmpireTable.subscribe('cellUnhighlightEvent', function(
                        oArgs
                    ) {
                        if (
                            oArgs.key == 'empire_name' ||
                    ...
                    this.EmpireTable.subscribe('cellClickEvent', function(ev) {
                        ...
                        if (column.key == 'empire_name') {
                            ...
                            Lacuna.Info.Empire.Load(
                                record.getData('empire_id')
                            );
                        } else if (column.key == 'alliance_name') {
                            record = this.getRecord(target);
                            Lacuna.Info.Alliance.Load(
                                record.getData('alliance_id')
                            );
                        }
                    });
                    ...
                    this.EmpireTable.set('generateRequest', function(
                        oState,
                        oSelf
                    ) {
                        // Set defaults
                        ...
                        var sort = encodeURIComponent(
                            ...
                            dir =
                                ...
                                oState.sortedBy.dir ===
                                    ...
                                    ? 'desc'
                                    : 'asc',
                            page = oState.pagination
                                ? oState.pagination.page
                                : 1;
            ...
            AllianceStats: function() {
                if (this.AllianceTable) {
                    ...
                    this.AllianceTable = new YAHOO.widget.ScrollingDataTable(
                        'statsAllianceTable',
                        this.AllianceColumns,
                        this.AllianceData,
                        {
                    ...
                    // Subscribe to events for row selection
                    this.AllianceTable.subscribe(
                        'rowMouseoverEvent',
                        this.AllianceTable.onEventHighlightRow
                    );
                    this.AllianceTable.subscribe(
                        'rowMouseoutEvent',
                        this.AllianceTable.onEventUnhighlightRow
                    );
                    this.AllianceTable.subscribe(
                        'rowClickEvent',
                        this.AllianceTable.onEventSelectRow
                    );
                    this.AllianceTable.subscribe(
                        'cellMouseoverEvent',
                        this.AllianceTable.onEventHighlightCell
                    );
                    this.AllianceTable.subscribe('cellHighlightEvent', function(
                        oArgs
                    ) {
                    ...
                    this.AllianceTable.subscribe('cellClickEvent', function(
                        ev
                    ) {
                        var target = Event.getTarget(ev),
                            column = this.getColumn(target);
                    ...
                    //overriding generateRequest to send the correct column name back
                    this.AllianceTable.set('generateRequest', function(
                        oState,
                        oSelf
                    ) {
                        // Set defaults
                    ...
                    this.AllianceTable.set('formatRow', function(
                        elTr,
                        oRecord
                    ) {
                        if (
                            this.selectedAllianceId &&
                            oRecord.getData('alliance_id') ==
                                this.selectedAllianceId
                        ) {
                            this.selectRow(oRecord);
                        }
            ...
            AllianceFindCreate: function() {
                ...
                oTextboxList.itemSelectEvent.subscribe(function(e, oArgs) {
                    oArgs[0]._elTextbox.value = '';
                    var data = oArgs[2];
                    Lacuna.Stats.AllianceTable.find(
                        data.alliance_id,
                        data.page_number
                    );
                });
            ...
            ColonyStats: function() {
                if (this.ColonyTable) {
                    ...
                    this.ColonyTable = new YAHOO.widget.ScrollingDataTable(
                        'statsColonyTable',
                        this.ColonyColumns,
                        this.ColonyData,
                        {
                            ...
                            initialRequest: Lang.JSON.stringify({
                                ...
                                method: 'colony_rank',
                                jsonrpc: '2.0',
                                params: [Game.GetSession(''), 'population'],
                            }),
                            dynamicData: true,
                            sortedBy: {
                                key: 'population',
                    ...
                    // Subscribe to events for row selection
                    this.ColonyTable.subscribe(
                        'rowMouseoverEvent',
                        this.ColonyTable.onEventHighlightRow
                    );
                    this.ColonyTable.subscribe(
                        'rowMouseoutEvent',
                        this.ColonyTable.onEventUnhighlightRow
                    );
                    this.ColonyTable.subscribe(
                        'rowClickEvent',
                        this.ColonyTable.onEventSelectRow
                    );
                    this.ColonyTable.subscribe(
                        'cellMouseoverEvent',
                        this.ColonyTable.onEventHighlightCell
                    );
                    this.ColonyTable.subscribe('cellHighlightEvent', function(
                        oArgs
                    ) {
                    ...
                    this.ColonyTable.subscribe('cellUnhighlightEvent', function(
                        oArgs
                    ) {
                        if (oArgs.key == 'empire_name') {
                            Dom.setStyle(oArgs.el, 'cursor', 'auto');
                    ...
                    //overriding generateRequest to send the correct column name back
                    this.ColonyTable.set('generateRequest', function(
                        oState,
                        oSelf
                    ) {
                        // Set defaults
                        ...
                        return Lang.JSON.stringify({
                            ...
                            method: 'colony_rank',
                            jsonrpc: '2.0',
                            params: [Game.GetSession(''), sort + '_rank'],
                        });
                    });
                }
            },
            SpyStats: function() {
                if (this.SpyTable) {
                    ...
                    this.SpyTable = new YAHOO.widget.ScrollingDataTable(
                        'statsSpyTable',
                        this.SpyColumns,
                        this.SpyData,
                        {
                    ...
                    // Subscribe to events for row selection
                    this.SpyTable.subscribe(
                        'rowMouseoverEvent',
                        this.SpyTable.onEventHighlightRow
                    );
                    this.SpyTable.subscribe(
                        'rowMouseoutEvent',
                        this.SpyTable.onEventUnhighlightRow
                    );
                    this.SpyTable.subscribe(
                        'rowClickEvent',
                        this.SpyTable.onEventSelectRow
                    );
                    this.SpyTable.subscribe(
                        'cellMouseoverEvent',
                        this.SpyTable.onEventHighlightCell
                    );
                    this.SpyTable.subscribe('cellHighlightEvent', function(
                        oArgs
                    ) {
                        if (oArgs.key == 'empire_name') {
                            Dom.setStyle(oArgs.el, 'cursor', 'help');
                    ...
                    this.SpyTable.subscribe('cellUnhighlightEvent', function(
                        oArgs
                    ) {
                        if (oArgs.key == 'empire_name') {
                            Dom.setStyle(oArgs.el, 'cursor', 'auto');
                    ...
                    //overriding generateRequest to send the correct column name back
                    this.SpyTable.set('generateRequest', function(
                        oState,
                        oSelf
                    ) {
                        // Set defaults
            ...
            WeeklyMedalStats: function() {
                if (this.WeeklyMedalTable) {
                    ...
                    this.WeeklyMedalTable = new YAHOO.widget.ScrollingDataTable(
                        'statsWeeklyMedalTable',
                        this.WeeklyMedalColumns,
                        this.WeeklyMedalData,
                        {
                            width: '100%',
                            height: wHt + 'px',
                            initialRequest: Lang.JSON.stringify({
                    ...
                    // Subscribe to events for row selection
                    this.WeeklyMedalTable.subscribe(
                        'rowMouseoverEvent',
                        this.WeeklyMedalTable.onEventHighlightRow
                    );
                    this.WeeklyMedalTable.subscribe(
                        'rowMouseoutEvent',
                        this.WeeklyMedalTable.onEventUnhighlightRow
                    );
                    this.WeeklyMedalTable.subscribe(
                        'rowClickEvent',
                        this.WeeklyMedalTable.onEventSelectRow
                    );
                    this.WeeklyMedalTable.subscribe(
                        'cellMouseoverEvent',
                    ...
                    this.WeeklyMedalTable.subscribe('cellClickEvent', function(
                        ev
                    ) {
                        var target = Event.getTarget(ev),
                            column = this.getColumn(target);
                    ...
                    //overriding generateRequest to send the correct column name back
                    this.WeeklyMedalTable.set('generateRequest', function(
                        oState,
                        oSelf
                    ) {
                        // Set defaults
