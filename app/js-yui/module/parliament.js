        ...
        Lang.extend(Parliament, Lacuna.buildings.Building, {
            ...
            _getCreateTab: function() {
                ...
                if (this.building.level >= 6) {
                    opts[opts.length] =
                        '<option value="proposeTransfer">Transfer Station Ownership</option>';
                    dis[dis.length] = [
                ...
                if (this.building.level >= 9) {
                    opts[opts.length] =
                        '<option value="proposeBroadcast">Broadcast on Net19</option>';
                    dis[dis.length] = [
                ...
                if (this.building.level >= 11) {
                    opts[opts.length] =
                        '<option value="proposeElectLeader">Elect New Leader</option>';
                    dis[dis.length] = [
                    ...
                    this.subscribe(
                        ...
                        function() {
                            ...
                            Event.on(
                                'proposeElectLeaderSubmit',
                                'click',
                                this.MemberNewLeader,
                                this,
                                true
                            );
                        },
                ...
                if (this.building.level >= 12) {
                    opts[opts.length] =
                        '<option value="proposeRenameAsteroid">Rename Asteroid</option>';
                    dis[dis.length] = [
                ...
                if (this.building.level >= 13) {
                    opts[opts.length] =
                        '<option value="proposeMembersMining">Members Only Mining Rights</option>';
                    dis[dis.length] = [
                ...
                if (this.building.level >= 14) {
                    opts[opts.length] =
                        '<option value="proposeEvictMining">Evict Mining Platform</option>';
                    dis[dis.length] = [
                ...
                if (this.building.level >= 17) {
                    opts[opts.length] =
                        '<option value="proposeRenameUninhabited">Rename Uninhabited</option>';
                    dis[dis.length] = [
                    ...
                    Event.on(
                        'proposeRenameUninhabitedSubmit',
                        'click',
                        this.RenameUninhabited,
                        this,
                        true
                    );
                }
                if (this.building.level >= 18) {
                    opts[opts.length] =
                        '<option value="proposeMembersColonize">Members Only Colonization</option>';
                    dis[dis.length] = [
                ...
                if (this.building.level >= 18) {
                    opts[opts.length] =
                        '<option value="proposeMembersStations">Members Only Stations</option>';
                    dis[dis.length] = [
                ...
                if (this.building.level >= 20) {
                    opts[opts.length] =
                        '<option value="proposeMembersExcavation">Members Only Excavation</option>';
                    dis[dis.length] = [
                    ...
                    Event.on(
                        'proposeMembersExcavationSubmit',
                        'click',
                        this.ExcavationOnly,
                        this,
                        true
                ...
                if (this.building.level >= 21) {
                    opts[opts.length] =
                        '<option value="proposeEvictExcav">Evict Excavator</option>';
                    dis[dis.length] = [
				...
				*/
                ...
                if (this.building.level >= 23) {
                    opts[opts.length] =
                        '<option value="proposeNeutralizeBHG">Neutralize BHG</option>';
                    dis[dis.length] = [
            ...
            ProposeWritTemplateChange: function() {
                var opt =
                    Game.Resources.writ_templates[
                        Lib.getSelectedOption('proposeWritTemplates').value
                    ];
                ...
                this.service.propose_members_only_stations(
                    ...
                    },
                    {
                        success: function(o) {
                            this.rpcSuccess(o);
                            this.proposeMessage.innerHTML =
                                'Successfully proposed to limit stations to members only.';
                            Lib.fadeOutElm(this.proposeMessage);
                            btn.disabled = false;
                        },
                        failure: function(o) {
                ...
                this.service.propose_members_only_colonization(
                    ...
                    },
                    {
                        success: function(o) {
                            this.rpcSuccess(o);
                            this.proposeMessage.innerHTML =
                                'Successfully proposed to limit colonization to members only.';
                            Lib.fadeOutElm(this.proposeMessage);
                            btn.disabled = false;
                        },
                        failure: function(o) {
                    ...
                    this.service.propose_evict_mining_platform(
                        ...
                        },
                        {
                            success: function(o) {
                                ...
                                this.rpcSuccess(o);
                                this.proposeMessage.innerHTML =
                                    'Successfully proposed to evict mining platforms.';
                                Lib.fadeOutElm(this.proposeMessage);
            ...
            FireBFG: function(e) {
                ...
                if (body && reason) {
                    if (
                        confirm(
                            'WARNING: The BFG is an extremly powerful weapon - do not point at face!!\n Are you sure you want to fire it?'
                        )
                    ) {
                        button.disabled = true;
                ...
                this.service.propose_neutralize_bhg(
                    ...
                    },
                    {
                        success: function(o) {
                            this.rpcSuccess(o);
                            this.proposeMessage.innerHTML =
                                'Successfully proposed to neutralize Black Hole Generators.';
                            Lib.fadeOutElm(this.proposeMessage);
                            btn.disabled = false;
                        },
                        failure: function(o) {
                ...
                this.service.propose_expel_member(
                    ...
                    },
                    {
                        success: function(o) {
                            this.rpcSuccess(o);
                            this.proposeMessage.innerHTML =
                                'Successfully proposed to expel member.';
                            Lib.fadeOutElm(this.proposeMessage);
                    ...
                    this.service.propose_induct_member(
                        ...
                        },
                        {
                            success: function(o) {
                                this.rpcSuccess(o);
                                this.proposeMessage.innerHTML =
                                    'Successfully proposed to induct member.';
                                Lib.fadeOutElm(this.proposeMessage);
                ...
                this.service.propose_members_only_mining_rights(
                    ...
                    },
                    {
                        success: function(o) {
                            this.rpcSuccess(o);
                            this.proposeMessage.innerHTML =
                                'Successfully proposed to limit mining rights to members only.';
                            Lib.fadeOutElm(this.proposeMessage);
                            btn.disabled = false;
                        },
                        failure: function(o) {
                ...
                this.service.propose_members_only_excavation(
                    ...
                    },
                    {
                        success: function(o) {
                            this.rpcSuccess(o);
                            this.proposeMessage.innerHTML =
                                'Successfully proposed to limit excavation to members only.';
                            Lib.fadeOutElm(this.proposeMessage);
                            btn.disabled = false;
                        },
                        failure: function(o) {
                    ...
                    this.service.propose_rename_uninhabited(
                        ...
                        },
                        {
                            success: function(o) {
                                ...
                                this.proposeMessage.innerHTML =
                                    'Successfully proposed to rename asteroid.';
                                Lib.fadeOutElm(this.proposeMessage);
                    ...
                    this.service.propose_rename_uninhabited(
                        ...
                        },
                        {
                            success: function(o) {
                                ...
                                this.proposeMessage.innerHTML =
                                    'Successfully proposed to rename uninhabited.';
                                Lib.fadeOutElm(this.proposeMessage);
                ...
                this.service.propose_transfer_station_ownership(
                    ...
                    },
                    {
                        success: function(o) {
                            this.rpcSuccess(o);
                            this.proposeMessage.innerHTML =
                                'Successfully proposed to transfer ownership of station.';
                            Lib.fadeOutElm(this.proposeMessage);
                ...
                if (details) {
                    ...
                    for (var i = 0; i < laws.length; i++) {
                        ...
                        nLi.innerHTML = [
                            ...
                            '</div>',
                            '<div class="lawDesc">',
                            this.formatBody(law.description),
                            '</div>',
                            '</div>',
                        ].join('');
