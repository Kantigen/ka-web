...
if (
    typeof YAHOO.lacuna.SpeciesDesigner == 'undefined' ||
    !YAHOO.lacuna.SpeciesDesigner
) {
    (function() {
        var Util = YAHOO.util,
            Dom = Util.Dom,
                ...
                this.speciesTemplates = [
                    {
                        name: 'Average',
                        description:
                            'Not specializing in any area, but without any particular weaknesses.',
                        min_orbit: 3,
                        max_orbit: 3,
                    ...
                    },
                    {
                        name: 'Resilient',
                        description:
                            'Resilient and able to colonize most any planet.  Somewhat docile, but very quick learners and above average at producing any resource.',
                        min_orbit: 2,
                        max_orbit: 7,
                    ...
                    },
                    {
                        name: 'Warmonger',
                        description:
                            'Adept at ship building and espionage. They are bent on domination.',
                        min_orbit: 4,
                        max_orbit: 5,
                        manufacturing_affinity: 4,
                    ...
                    },
                    {
                        name: 'Viral',
                        description:
                            'Proficient at growing at the most expedient pace like a virus in the Expanse.',
                        min_orbit: 1,
                        max_orbit: 7,
        ...
        SpeciesDesigner.prototype = {
            render: function(el) {
                ...
                if (this.speciesTemplates.length > 0) {
                    ...
                    Dom.setStyle(
                        Sel.query('.speciesButtons', container, true),
                        'display',
                        'none'
                    );
                }
            ...
            _createSliders: function() {
                ...
                this.speciesConst = this._createHorizSingle(
                    'speciesConst',
                    'speciesConst_thumb',
                    'speciesConst_num'
                );
                this.speciesDecep = this._createHorizSingle(
                    'speciesDecep',
                    'speciesDecep_thumb',
                    'speciesDecep_num'
                );
                this.speciesResearch = this._createHorizSingle(
                    'speciesResearch',
                    'speciesResearch_thumb',
                    'speciesResearch_num'
                );
                this.speciesManagement = this._createHorizSingle(
                    'speciesManagement',
                    'speciesManagement_thumb',
                    'speciesManagement_num'
                );
                this.speciesFarming = this._createHorizSingle(
                    'speciesFarming',
                    'speciesFarming_thumb',
                    'speciesFarming_num'
                );
                this.speciesMining = this._createHorizSingle(
                    'speciesMining',
                    'speciesMining_thumb',
                    'speciesMining_num'
                );
                this.speciesScience = this._createHorizSingle(
                    'speciesScience',
                    'speciesScience_thumb',
                    'speciesScience_num'
                );
                this.speciesEnviro = this._createHorizSingle(
                    'speciesEnviro',
                    'speciesEnviro_thumb',
                    'speciesEnviro_num'
                );
                this.speciesPolitical = this._createHorizSingle(
                    'speciesPolitical',
                    'speciesPolitical_thumb',
                    'speciesPolitical_num'
                );
                this.speciesTrade = this._createHorizSingle(
                    'speciesTrade',
                    'speciesTrade_thumb',
                    'speciesTrade_num'
                );
                this.speciesGrowth = this._createHorizSingle(
                    'speciesGrowth',
                    'speciesGrowth_thumb',
                    'speciesGrowth_num'
                );

                this.elTotal = Sel.query(
                    '.speciesPointTotal',
                    this.container,
                    true
                );
                this.elTotal.innerHTML = 45;
                this.elTotalLine = Sel.query(
                    '.speciesPointLine',
                    this.container,
                    true
                );
                ...
                this.speciesResearch.subscribe(
                    'change',
                    updateTotal,
                    this,
                    true
                );
                this.speciesManagement.subscribe(
                    'change',
                    updateTotal,
                    this,
                    true
                );
                this.speciesFarming.subscribe(
                    'change',
                    updateTotal,
                    this,
                    true
                ...
                this.speciesPolitical.subscribe(
                    'change',
                    updateTotal,
                    this,
                    true
            ...
            _createTooltips: function() {
                this._affinityTooltip = new YAHOO.widget.Tooltip(
                    Dom.generateId(),
                    {
                        //iframe:true,
                        zIndex: 1,
            ...
            _createHabitableOrbits: function() {
                ...
                var mins = new YW.Slider(
                    elSlider.id,
                    elSlider.id,
                    mint,
                    'horiz'
                );
                var maxs = new YW.Slider(
                    elSlider.id,
                    elSlider.id,
                    maxt,
                    'horiz'
                    ...
                    slider,
                    {
                        ...
                        updateHighlight: function() {
                            ...
                            Dom.setStyle(
                                this._highlight,
                                'width',
                                Math.max(delta + 27, 0) + 'px'
                            );
                        },
                        getMinOrbit: function() {
                            return (
                                Math.round((this.minVal - 14) / tickSize) + 1
                            );
                        },
                        getMaxOrbit: function() {
                            return (
                                Math.round((this.maxVal + 14) / tickSize) + 1
                            );
                        },
            ...
            _createHorizSingle: function(container, thumb, num) {
                ...
                // Create the Slider
                var slider = Slider.getHorizSlider(
                    container.id,
                    thumb.id,
                    0,
                    range,
            ...
            setSpeciesData: function(data) {
                ...
                this.speciesHO.setOrbits(
                    data.min_orbit,
                    data.max_orbit,
                    true,
                    true
                );
                this.speciesConst.setAffinity(
                    data.manufacturing_affinity,
                    true,
                    true
                );
                this.speciesDecep.setAffinity(
                    data.deception_affinity,
                    true,
                    true
                );
                this.speciesResearch.setAffinity(
                    data.research_affinity,
                    true,
                    true
                );
                this.speciesManagement.setAffinity(
                    data.management_affinity,
                    true,
                    true
                );
                this.speciesFarming.setAffinity(
                    data.farming_affinity,
                    true,
                    true
                );
                this.speciesMining.setAffinity(
                    data.mining_affinity,
                    true,
                    true
                );
                this.speciesScience.setAffinity(
                    data.science_affinity,
                    true,
                    true
                );
                this.speciesEnviro.setAffinity(
                    data.environmental_affinity,
                    true,
                    true
                );
                this.speciesPolitical.setAffinity(
                    data.political_affinity,
                    true,
                    true
                );
                this.speciesTrade.setAffinity(data.trade_affinity, true, true);
                this.speciesGrowth.setAffinity(
                    data.growth_affinity,
                    true,
                    true
                );
            ...
            compareSpeciesData: function(species1, species2) {
                return (
                    species1.manufacturing_affinity ==
                        species2.manufacturing_affinity &&
                    species1.deception_affinity ==
                        species2.deception_affinity &&
                    species1.research_affinity == species2.research_affinity &&
                    species1.management_affinity ==
                        species2.management_affinity &&
                    ...
                    species1.environmental_affinity ==
                        species2.environmental_affinity &&
                    species1.political_affinity ==
                        species2.political_affinity &&
            ...
            validateSpecies: function(data) {
                if (data.affinity_total > 45) {
                    ...
                    if (
                        confirm(
                            "Setting an affinity to 1 is an expert setting, and is not recommended unless you're absolutely sure you know what you're doing.  Are you sure you want to continue?"
                        )
                    ) {
                        this._expert = true;
                    } else {
            ...
            _getHtml: function() {
                ...
                return [
                    ...
                    '    <ul>',
                    '        <li style="margin-bottom:3px;"><label for="',
                    nameId,
                    '">Species Name</label><input id="',
                    nameId,
                    '" type="text" class="speciesName" maxlength="30" size="30" /></label></li>',
                    '        <li><label for="',
                    descId,
                    '">Description</label><textarea id="',
                    descId,
                    '" class="speciesDesc" cols="40" rows="4"></textarea></li>',
                    ...
                    '                                 <div class="speciesHO_min_thumb speciesSliderThumb"><span class="speciesHO_from thumbDisplay">1</span><img src="',
                    Lib.AssetUrl,
                    'ui/web/slider-thumb-half-left.png" /></div>',
                    '                        </div>',
                    '                        <div class="speciesHO_max">',
                    '                            <div class="speciesHO_max_thumb speciesSliderThumb"><span class="speciesHO_to thumbDisplay">1</span><img src="',
                    Lib.AssetUrl,
                    'ui/web/slider-thumb-half-right.png" /></div>',
                    '                        </div>',
                    '                    </div>',
                    '                </li>',
                    ...
                    '                        <span class="speciesSlider_lock"><span class="speciesSlider_lock_bg"></span></span>',
                    '                        <div class="speciesConst_thumb speciesSliderThumb"><span class="speciesConst_num thumbDisplay">1</span><img src="',
                    Lib.AssetUrl,
                    'ui/web/slider-thumb.png" /></div>',
                    '                    </div>',
                    '                </li>',
                    ...
                    '                        <span class="speciesSlider_lock"><span class="speciesSlider_lock_bg"></span></span>',
                    '                        <div class="speciesDecep_thumb speciesSliderThumb"><span class="speciesDecep_num thumbDisplay">1</span><img src="',
                    Lib.AssetUrl,
                    'ui/web/slider-thumb.png" /></div>',
                    '                    </div>',
                    '                </li>',
                    ...
                    '                        <span class="speciesSlider_lock"><span class="speciesSlider_lock_bg"></span></span>',
                    '                        <div class="speciesResearch_thumb speciesSliderThumb"><span class="speciesResearch_num thumbDisplay">1</span><img src="',
                    Lib.AssetUrl,
                    'ui/web/slider-thumb.png" /></div>',
                    '                    </div>',
                    '                </li>',
                    ...
                    '                        <span class="speciesSlider_lock"><span class="speciesSlider_lock_bg"></span></span>',
                    '                        <div class="speciesManagement_thumb speciesSliderThumb"><span class="speciesManagement_num thumbDisplay">1</span><img src="',
                    Lib.AssetUrl,
                    'ui/web/slider-thumb.png" /></div>',
                    '                    </div>',
                    '                </li>',
                    ...
                    '                        <span class="speciesSlider_lock"><span class="speciesSlider_lock_bg"></span></span>',
                    '                        <div class="speciesFarming_thumb speciesSliderThumb"><span class="speciesFarming_num thumbDisplay">1</span><img src="',
                    Lib.AssetUrl,
                    'ui/web/slider-thumb.png" /></div>',
                    '                    </div>',
                    '                </li>',
                    ...
                    '                        <span class="speciesSlider_lock"><span class="speciesSlider_lock_bg"></span></span>',
                    '                        <div class="speciesMining_thumb speciesSliderThumb"><span class="speciesMining_num thumbDisplay">1</span><img src="',
                    Lib.AssetUrl,
                    'ui/web/slider-thumb.png" /></div>',
                    '                    </div>',
                    '                </li>',
                    ...
                    '                        <span class="speciesSlider_lock"><span class="speciesSlider_lock_bg"></span></span>',
                    '                        <div class="speciesScience_thumb speciesSliderThumb"><span class="speciesScience_num thumbDisplay">1</span><img src="',
                    Lib.AssetUrl,
                    'ui/web/slider-thumb.png" /></div>',
                    '                    </div>',
                    '                </li>',
                    ...
                    '                        <span class="speciesSlider_lock"><span class="speciesSlider_lock_bg"></span></span>',
                    '                        <div class="speciesEnviro_thumb speciesSliderThumb"><span class="speciesEnviro_num thumbDisplay">1</span><img src="',
                    Lib.AssetUrl,
                    'ui/web/slider-thumb.png" /></div>',
                    '                    </div>',
                    '                </li>',
                    ...
                    '                        <span class="speciesSlider_lock"><span class="speciesSlider_lock_bg"></span></span>',
                    '                        <div class="speciesPolitical_thumb speciesSliderThumb"><span class="speciesPolitical_num thumbDisplay">1</span><img src="',
                    Lib.AssetUrl,
                    'ui/web/slider-thumb.png" /></div>',
                    '                    </div>',
                    '                </li>',
                    ...
                    '                        <span class="speciesSlider_lock"><span class="speciesSlider_lock_bg"></span></span>',
                    '                        <div class="speciesTrade_thumb speciesSliderThumb"><span class="speciesTrade_num thumbDisplay">1</span><img src="',
                    Lib.AssetUrl,
                    'ui/web/slider-thumb.png" /></div>',
                    '                    </div>',
                    '                </li>',
                    ...
                    '                        <span class="speciesSlider_lock"><span class="speciesSlider_lock_bg"></span></span>',
                    '                        <div class="speciesGrowth_thumb speciesSliderThumb"><span class="speciesGrowth_num thumbDisplay">1</span><img src="',
                    Lib.AssetUrl,
                    'ui/web/slider-thumb.png" /></div>',
                    '                    </div>',
                    '                </li>',
