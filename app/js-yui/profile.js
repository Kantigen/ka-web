    ...
    (function() {
        ...
        Profile.prototype = {
                    ...
                    buttons: [
                        {
                            text:
                                ' <img src="' +
                                Lib.AssetUrl +
                                'ui/s/essentia.png" class="smallEssentia" /> Update',
            ...
            handleUpdate: function() {
                ...
                if (
                    Game.GetCookieSettings('disableDialogAnim', '0') !=
                    (this.stopAnim.checked ? '1' : '0')
                ) {
                    var newEffect;
                ...
                if (
                    Game.GetCookieSettings('showLevels', '0') !=
                    (this.showLevels.checked ? '1' : '0')
                ) {
                ...
                if (
                    Game.GetCookieSettings('hidePlanets', '0') !=
                    (this.hidePlanets.checked ? '1' : '0')
                ) {
                    ...
                    if (YAHOO.lacuna.MapStar.IsVisible()) {
                        YAHOO.lacuna.MapStar._map.hidePlanets =
            ...
            show: function() {
                ...
                Game.Services.Empire.get_own_profile(
                    { session_id: Game.GetSession('') },
                    {
                        success: function(o) {
