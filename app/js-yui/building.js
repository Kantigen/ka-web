        ...
        Building.prototype = {
            ...
            getTabs: function() {
                if (
                    ...
                    if (
                        this.building.url == '/planetarycommand' ||
                        this.building.url == '/stationcommand'
                    ) {
        ...
        */
            ...
            _details: function(info) {
                ...
                return [
                    ...
                    '">',
                    Lib.convertNumDisplay(info.amount),
                    info.suffix,
                    '</span></li>',
                ].join('');
            },
                        ...
                        up
                            ? [
                                  ...
                                  this._details({
                                      ...
                                      numclass:
                                          up.cost.water > planet.water_stored
                                              ? 'low-resource'
                                              : null,
                                  }),
                                  this._details({
                                      ...
                                      numclass:
                                          up.cost.energy > planet.energy_stored
                                              ? 'low-resource'
                                              : null,
                                  }),
                                  this._details({
