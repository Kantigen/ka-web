    ...
    (function() {
        ...
        var Login = function() {
            ...
            container.innerHTML = [
                ...
                '                </form>',
                '            </div>',
                '            <div class="loginCreateTable"><div class="loginCreate">',
                //'                <ul>',
        ...
        var ResetPassword = function(Login) {
            ...
            this.EmailDialog.renderEvent.subscribe(
                function() {
            ...
            this.ResetDialog.renderEvent.subscribe(
                function() {
