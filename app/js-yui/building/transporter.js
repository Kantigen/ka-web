...
if (
    typeof YAHOO.lacuna.buildings.Transporter == 'undefined' ||
    !YAHOO.lacuna.buildings.Transporter
) {
    (function() {
        var Lang = YAHOO.lang,
            Util = YAHOO.util,
        ...
        var Transporter = function(result) {
            ...
            this.addTradeText = [
                'Add Trade For 1<img src="',
                Lib.AssetUrl,
                'ui/s/essentia.png" class="smallEssentia smallImg" />',
            ].join('');
            this.pushTradeText = [
                'Send For 2<img src="',
                Lib.AssetUrl,
            ...
            if (this.building.level > 0) {
                ...
                p.innerHTML =
                    'Transporter has a maximum capacity of ' +
                    this.transport.max +
                    ' at this level.';
        ...
        Lang.extend(Transporter, Lacuna.buildings.Building, {
            ...
            _getOneForOneTab: function() {
                this.oneForOne = new YAHOO.widget.Tab({
                    label: 'One For One',
                    content: [
                        '<div class="transporterOneForOne">',
                        '<div>You may trade one-for-one with Lacuna Corp for 3<img src="',
                        Lib.AssetUrl,
                        'ui/s/essentia.png" class="smallEssentia smallImg" /> per transaction.</div>',
                        '<ul>',
            ...
            _getAvailTab: function() {
                ...
                Event.on(
                    ...
                    'change',
                    function(e) {
                        this.getAvailable({ newValue: true });
                    },
                    this,
                    true
                );
                ...
                if (details) {
                    ...
                    for (var i = 0; i < trades.length; i++) {
                        ...
                        bbtn.innerHTML = [
                            ...
                            '<img src="',
                            Lib.AssetUrl,
                            'ui/s/essentia.png" class="smallEssentia" /> Total',
                        ].join('');
            ...
            AddPlan: function(e, matchedEl, container) {
                ...
                if (li && c) {
                    var pName = li.Plan.name,
                        ...
                        id = ['addPlan-', pType, '-', pLevel, '-', pExtra]
                            .join('')
                            .titleCaps(' ', '_'),
                        exists = Sel.query('#' + id, c);
                    if (exists.length == 0) {
            ...
            AddShip: function(e, matchedEl, container) {
                ...
                if (li && c) {
                    var sName = li.Ship.name,
                        ...
                        id = ['addShip', sName, sType, sSize, sBerth, sSpeed]
                            .join('-')
                            .titleCaps(' ', '_'),
                        exists = Sel.query('#' + id, c);
                    if (exists.length == 0) {
            ...
            PushAddPlan: function(e, matchedEl, container) {
                ...
                if (quantity && li && c) {
                    var pName = li.Plan.name,
                        ...
                        pLevel = li.Plan.level,
                        pExtra = li.Plan.extra_build_level,
                        id = ['pushPlan-', pType, '-', pLevel, '-', pExtra]
                            .join('')
                            .titleCaps(' ', '_'),
                        exists = Sel.query('#' + id, c);
            ...
            PushAddShip: function(e, matchedEl, container) {
                ...
                if (li && c) {
                    var sName = li.Ship.name,
                        ...
                        sBerth = li.Ship.berth_level,
                        sSpeed = li.Ship.speed,
                        id = ['pushShip-', sName, sType, sSize, sBerth, sSpeed]
                            .join('-')
                            .titleCaps(' ', '_'),
                        exists = Sel.query('#' + id, c);
                    if (exists.length == 0) {
