...
if (
    typeof YAHOO.lacuna.buildings.SpacePort === 'undefined' ||
    !YAHOO.lacuna.buildings.SpacePort
) {
    (function() {
        var Lang = YAHOO.lang,
            Util = YAHOO.util,
        ...
        Lang.extend(SpacePort, Lacuna.buildings.Building, {
            ...
            getChildTabs: function() {
                return [
                    this._getTravelTab(),
                    this._getViewTab(),
                    this._getOrbitingTab(),
                    this._getForeignTab(),
                    this._getLogsTab(),
                    this._getSendTab(),
                    this._getSendFleetTab(),
                ];
            },
            ...
            */
            ...
            _getOrbitingTab: function() {
                ...
                this.viewOrbitingTab.subscribe(
                    'activeChange',
                    this.getOrbiting,
                    this,
                    true
            ...
            _getSendFleetTab: function() {
                ...
                this.sendFleetTab = new YAHOO.widget.Tab({
                    ...
                    content: [
                        ...
                        Lib.padit(currDay, '0'),
                        ':',
                        Lib.padit(currHour, '0'),
                        ':',
                        Lib.padit(currMin, '0'),
                        '</div>',
                        '        <div>Set Arrival time: (GMT) YYYY:MM:DD:HH:MM</div>',
                        '        <div>',
                        '             <input type="text" id="setArrivalYear" value="' +
                            currYear +
                            '" size="4">:',
                        '             <input type="text" id="setArrivalMon" value="' +
                            currMon +
                            '" size="2">:',
                        '             <input type="text" id="setArrivalDay" value="' +
                            currDay +
                            '" size="2">:',
                        '             <input type="text" id="setArrivalHour" value="' +
                            currHour +
                            '" size="2">:',
                        '             <input type="text" id="setArrivalMin" value="' +
                            currMin +
                            '" size="2">',
                        '        </div>',
                        '    </div>',
                                ...
                                success: function(o) {
                                    ...
                                    this.shipsTravelling = {
                                        number_of_ships_travelling:
                                            o.result.number_of_ships_travelling,
                                        ships_travelling:
                                            o.result.ships_travelling,
                                    };
                                    ...
                                    this.shipsPager.subscribe(
                                        'changeRequest',
                                        this.ShipHandlePagination,
                                        this,
                                        true
                                    );
                        ...
                        this.service.view_all_ships(
                            ...
                            },
                            {
                                success: function(o) {
                                    ...
                                    this.viewPager.subscribe(
                                        'changeRequest',
                                        this.ViewHandlePagination,
                                        this,
                                        true
                                    );
                        ...
                        this.service.view_foreign_ships(
                            ...
                            },
                            {
                                success: function(o) {
                                    ...
                                    this.foreignPager.subscribe(
                                        'changeRequest',
                                        this.ForeignHandlePagination,
                                        this,
                                        true
                                    );
                        ...
                        this.service.view_battle_logs(
                            ...
                            },
                            {
                                success: function(o) {
                                    ...
                                    this.logsPager.subscribe(
                                        'changeRequest',
                                        this.LogsHandlePagination,
                                        this,
                                        true
                                    );
                        ...
                        this.service.view_ships_orbiting(
                            ...
                            },
                            {
                                success: function(o) {
                                    ...
                                    this.orbitingPager.subscribe(
                                        'changeRequest',
                                        this.OrbitingHandlePagination,
                                        this,
                                        true
                                    );
            ...
            SpacePortPopulate: function() {
                ...
                if (details) {
                    ...
                    for (var i = 0; i < ships.length; i++) {
                        ...
                        nLi.innerHTML = [
                            '<div class="yui-g" style="margin-bottom:2px;">',
                            '<div class="yui-g first">',
                            '    <div class="yui-u first" style="background:transparent url(',
                            Lib.AssetUrl,
                            ...
                            '            <li style="white-space:nowrap;"><label style="font-style:italic">Arrives In: </label><span class="shipArrives">',
                            Lib.formatTime(sec),
                            '</span></li>',
                            '            <li style="white-space:nowrap;"><label style="font-style:italic">From: </label><span class="shipFrom">',
                            ship.from.name,
                            '</span></li>',
                            '            <li style="white-space:nowrap;"><label style="font-style:italic">To: </label><span class="shipTo">',
                            ship.to.name,
                            '</span></li>',
                            '        </ul>',
                            '    </div>',
                            ...
                            '        <li style="white-space:nowrap;"><label style="font-style:italic">Speed: </label>',
                            ship.fleet_speed > 0 &&
                            ship.fleet_speed < ship.speed
                                ? ship.fleet_speed
                                : ship.speed,
                            '</li>',
                            '        <li style="white-space:nowrap;"><label style="font-style:italic">Hold Size: </label>',
                            ship.hold_size,
                            '</li>',
                            '        <li style="white-space:nowrap;"><label style="font-style:italic">Stealth: </label>',
                            ship.stealth,
                            '</li>',
                            '        <li style="white-space:nowrap;"><label style="font-style:italic">Combat: </label>',
                            ship.combat,
                            '</li>',
                            '        <li style="white-space:nowrap;"><label style="font-style:italic">Occupants: </label>',
                            ship.max_occupants,
                            '</li>',
                            '        <li style="white-space:nowrap;"><label style="font-style:italic">Ship ID: </label>',
                            ship.id,
                            '</li>',
                            '        </ul>',
                            '    </div>',
            ...
            ViewActionDetails: function(nLi, ship, noEvent) {
                var ulDet = [
                    '<li style="white-space:nowrap;"><label style="font-weight:bold;">',
                    ship.task,
                    '</label></li>',
                ];
                ...
                if (ship.task === 'Docked') {
                    ulDet[ulDet.length] =
                        '<li style="white-space:nowrap;margin-top:5px"><button type="button" class="scuttle">Scuttle</button></li>';
                    ...
                    ulDet[ulDet.length] =
                        '</span></li><li style="white-space:nowrap;"><label style="font-style:italic">From: </label><span class="shipFrom">';
                    ulDet[ulDet.length] = ship.from.name;
                    ulDet[ulDet.length] =
                        '</span></li><li style="white-space:nowrap;"><label style="font-style:italic">To: </label><span class="shipTo">';
                    ...
                    ulDet[ulDet.length] =
                        '<li style="white-space:nowrap;"><span class="shipTo">';
                    ulDet[ulDet.length] = ship.orbiting.name;
                    ulDet[ulDet.length] =
                        '</span></li><li style="white-space:nowrap;margin-top:5px"><button type="button" class="recall">Recall</button></li>';
                ...
                if (ship.payload && ship.payload.length > 0) {
                    ulDet[ulDet.length] =
                        '<li style="white-space:nowrap;margin-top:5px"><button type="button" class="payload">Payload</button></li>';
            ...
            ViewPopulate: function() {
                ...
                if (details) {
                    ...
                    if (info && this.result.max_ships > 0) {
                        info.innerHTML = [
                            '<div>This SpacePort can dock a maximum of ',
                            this.result.max_ships,
                            ' ships. There are ',
                            this.result.docks_available,
                            ' docks available.',
                        ].join('');
                    }
                    ...
                    for (var i = 0; i < ships.length; i++) {
                        ...
                        nLi.innerHTML = [
                            ...
                            ship.fleet_speed > 0 &&
                            ship.fleet_speed < ship.speed
                                ? '        <li style="white-space:nowrap;"><label style="font-style:italic">Fleet Speed: </label>' +
                                  ship.fleet_speed +
                                  '</li>'
                                : '',
                            '        <li style="white-space:nowrap;"><label style="font-style:italic">Speed: </label>',
                            Lib.formatNumber(ship.speed),
                            '</li>',
                            '        <li style="white-space:nowrap;"><label style="font-style:italic">Hold Size: </label>',
                            Lib.formatNumber(ship.hold_size),
                            '</li>',
                            '        <li style="white-space:nowrap;"><label style="font-style:italic">Berth Level: </label>',
                            ship.berth_level,
                            '</li>',
                            '        </ul>',
                            ...
                            '</li>',
                            '        <li style="white-space:nowrap;"><label style="font-style:italic">Stealth: </label>',
                            Lib.formatNumber(ship.stealth),
                            '</li>',
                            '        <li style="white-space:nowrap;"><label style="font-style:italic">Combat: </label>',
                            Lib.formatNumber(ship.combat),
                            '</li>',
                            '        <li style="white-space:nowrap;"><label style="font-style:italic">Ship ID: </label>',
                            ship.id,
                            '</li>',
            ...
            LogsPopulate: function() {
                ...
                if (details) {
                    ...
                    for (var i = 0; i < logs.length; i++) {
                        ...
                        nLi.innerHTML =
                            '<label>Victory:</label> ' +
                            log.victory_to.replace(/^\w/, function(c) {
                ...
                if (details) {
                    ...
                    for (var i = 0; i < ships.length; i++) {
                        var ship = ships[i],
                            ...
                            nLi = li.cloneNode(false),
                            sec =
                                (Lib.getTime(ship.date_arrived) - serverTime) /
                                1000;
                        nUl.Ship = ship;
                        Dom.addClass(nUl, 'shipInfo');
                        Dom.addClass(nUl, 'clearafter');
                        ...
                        },
                        {
                            success: function(o) {
                                ...
                                if (info) {
                                    ...
                                    info.innerHTML = [
                                        'This SpacePort can dock a maximum of ',
                                        this.Self.result.max_ships,
                                        ' ships. There are ',
                                        this.Self.result.docks_available,
                                        ' docks available.',
                                    ].join('');
                ...
                this.Self.service.recall_ship(
                    ...
                    },
                    {
                        success: function(o) {
                            ...
                            //set to travelling
                            var ad = Sel.query(
                                'ul.shipActionDetails',
                                this.Line,
                                true
                            );
                            ad.innerHTML = this.Self.ViewActionDetails(
                                this.Line,
                                o.result.ship,
                                true
                            );
            ...
            GetShipsFor: function() {
                ...
                if (type === 'xy') {
                    ...
                    Dom.get('sendShipNote').innerHTML = [
                        'X: ',
                        target.x,
                        ' - Y: ',
                        target.y,
            ...
            GetFleetFor: function() {
                ...
                if (type === 'xy') {
                    ...
                    Dom.get('sendFleetNote').innerHTML = [
                        'X: ',
                        target.x,
                        ' - Y: ',
                        target.y,
                ...
                if (ships.length === 0) {
                    ...
                    for (var i = 0; i < ships.length; i++) {
                        ...
                        nLi.innerHTML = [
                            ...
                            '    <div class="yui-g first">',
                            '        <div class="yui-u first" style="width:64px;background:transparent url(',
                            Lib.AssetUrl,
                            'star_system/field.png) no-repeat center;text-align:center;">',
                            '            <img src="',
                            Lib.AssetUrl,
            ...
            FleetSend: function(e) {
                ...
                if (earliest === true) {
                    ...
                    if (isNaN(arrivalDate.year)) {
                        arrivalDate.year = currYear;
                    }
                    arrivalDate.month = Dom.get('setArrivalMon').value;
                    if (isNaN(arrivalDate.month)) {
                        arrivalDate.month = currMon;
                    }
                    arrivalDate.day = Dom.get('setArrivalDay').value;
                    if (isNaN(arrivalDate.day)) {
                        arrivalDate.day = currDay;
                    }
                    arrivalDate.hour = Dom.get('setArrivalHour').value;
                    if (isNaN(arrivalDate.hour)) {
                        arrivalDate.hour = currHour;
                    }
                    arrivalDate.minute = Dom.get('setArrivalMin').value;
                    if (isNaN(arrivalDate.minute)) {
                        arrivalDate.minute = currMin;
                    }
