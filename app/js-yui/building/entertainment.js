...
if (
    typeof YAHOO.lacuna.buildings.Entertainment == 'undefined' ||
    !YAHOO.lacuna.buildings.Entertainment
) {
    (function() {
        var Util = YAHOO.util,
            Dom = Util.Dom,
        ...
        var Entertainment = function(result) {
            ...
            this.lotteryAllVotedMessage =
                'You have voted as many times as you could today.  Please check back tomorrow for your next chance!';
        };
        ...
        YAHOO.lang.extend(Entertainment, Lacuna.buildings.Building, {
            ...
            _getLotteryTab: function() {
                var tab = new YAHOO.widget.Tab({
                    label: 'Lottery',
                    content: [
                        '<p id="entertainmentLotteryMessage">Welcome to the Lacuna Lottery! Get entered in the Expanse\'s daily lottery for a chance to win 10 <img src="',
                        Lib.AssetUrl,
                        'ui/s/essentia.png" class="smallEssentia" />! Each link clicked below gives you one extra chance to win. Links will be removed after voting and return tomorrow.</p><div><ul id="entertainmentLotteryList"></ul></div>',
                    ].join(''),
                });
            ...
            SetQuacks: function() {
                Dom.get('entertainmentTotalQuacks').innerHTML = [
                    'There have been a total of ',
                    this.result.ducks_quacked || 0,
                    ' ducks quacked.',
                ].join('');
            },
            Quack: function() {
