...
if (
    ...
    !YAHOO.lacuna.buildings.GeneticsLab
) {
    (function() {
        var Lang = YAHOO.lang,
            Util = YAHOO.util,
                            ...
                            success: function(o) {
                                ...
                                if (o.result.can_experiment == 1) {
                                    ...
                                    Dom.get('geneticsLabMessage').innerHTML =
                                        'Unable to currently run experiments.  You can only have 1 graft per level of the Genetics Lab.';
                                }
                            },
                            scope: this,
                        }
