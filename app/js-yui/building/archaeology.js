...
if (
    typeof YAHOO.lacuna.buildings.Archaeology == 'undefined' ||
    !YAHOO.lacuna.buildings.Archaeology
) {
    (function() {
        var Lang = YAHOO.lang,
            Util = YAHOO.util,
        ...
        Lang.extend(Archaeology, Lacuna.buildings.Building, {
            getChildTabs: function() {
                return [
                    this._getSearchTab(),
                    this._getViewTab(),
                    this._getExcavatorTab(),
                    this._getAbandonExcavatorTab(),
                ];
            },
            _getSearchTab: function() {
                var tab = new YAHOO.widget.Tab({
                    ...
                    content: [
                        ...
                        '    <li>You may subsidize the search for 2 <img src="',
                        Lib.AssetUrl,
                ...
                if (details) {
                    ...
                    if (excavators.length > 0) {
                        info.innerHTML = [
                            ...
                            excavators.length - 1,
                            ' excavators deployed. ',
                            this.excavators.travel_e,
                            ' en route. This ministry can control a maximum of ',
                    ...
                    if (excavators.length > 0) {
                        for (var i = 0; i < excavators.length; i++) {
                            ...
                            Event.on(
                                bbtn,
                                'click',
                                this.ExcavatorAbandon,
                                { Self: this, Excavator: obj, Line: nUl },
                                true
                            );
                        }
                    }
            ...
            ExcavatorAbandon: function() {
                if (
                    confirm(
                        [
                            'Are you sure you want to Abandon the excavator ',
                            this.Excavator.id,
                            ' at  ',
                            this.Excavator.body.name,
                            '?',
                        ].join('')
                    )
                ) {
                    ...
                    for (var i = 0; i < ore.length; i++) {
                        ...
                        if (this.ore.hasOwnProperty(oKey)) {
                            ...
                            nOpt.innerHTML = [
                                oKey,
                                ' (',
                                Lib.formatNumber(this.ore[oKey]),
                                ')',
                            ].join('');
                ...
                if (details) {
                    ...
                    for (var i = 0; i < glyphs.length; i++) {
                        ...
                        nLi.innerHTML = [
                            ...
                            '  <div class="archaeologyGlyphHeader">',
                            obj.type,
                            ' (',
                            obj.quantity,
                            ')</div>',
                            ...
                            '" title="',
                            obj.type,
                            '" style="width:79px;height:100px;" />', //"width:119px;height:150px;"
                            '</div>',
                        ].join('');
