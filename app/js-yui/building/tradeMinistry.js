    ...
    (function() {
                            ...
                            function(e) {
                                if (e.newValue) {
                                    ...
                                    if (!this.tradePushSubbed) {
                                        ...
                                        Event.on(
                                            'tradePushGlyphSummary',
                                            'click',
                                            function() {
                                                if (
                                                    Dom.getStyle(
                                                        'tradePushGlyphSummaryName',
                                                        'display'
                                                    ) == 'none'
                                                ) {
                                                    Dom.setStyle(
                                        ...
                                        Event.on(
                                            'tradePushPlanSummary',
                                            'click',
                                            function() {
                                                if (
                                                    Dom.getStyle(
                                                        'tradePushPlanSummaryName',
                                                        'display'
                                                    ) == 'none'
                                                ) {
                                                    Dom.setStyle(
                                        ...
                                        Event.on(
                                            'tradePushShipSummary',
                                            'click',
                                            function() {
                                                if (
                                                    Dom.getStyle(
                                                        'tradePushShipSummaryName',
                                                        'display'
                                                    ) == 'none'
                                                ) {
                                                    Dom.setStyle(
                            ...
                            function(e) {
                                if (e.newValue) {
                                    ...
                                    if (!this.tradeAddSubbed) {
                                        ...
                                        Event.on(
                                            'tradeAddGlyphSummary',
                                            'click',
                                            function() {
                                                if (
                                                    Dom.getStyle(
                                                        'tradeAddGlyphSummaryName',
                                                        'display'
                                                    ) == 'none'
                                                ) {
                                                    Dom.setStyle(
        ...
        Lang.extend(Trade, Lacuna.buildings.Building, {
            ...
            getChildTabs: function() {
                ...
                return [
                    this._getPushTab(),
                    this._getAvailableTradesTab(),
                    this._getMyTradesTab(),
                    this._getAddTradeTab(),
                    this._getSupplyChainTab(),
                    this._getSupplyShipsTab(),
                    this._getWasteChainTab(),
                ];
            },
            ...
            _getAvailableTradesTab: function() {
                ...
                Event.on(
                    ...
                    'change',
                    function(e) {
                        this.getAvailableTrades({ newValue: true });
                    },
                    this,
                    true
                );
            ...
            _getSupplyChainTab: function() {
                ...
                Event.on(
                    'supplyChainAddButton',
                    'click',
                    this.SupplyChainAddNew,
                    { Self: this },
                    true
                );
                    ...
                    this.service.view_market(data, {
                        success: function(o) {
                            ...
                            this.availablePager.subscribe(
                                'changeRequest',
                                this.AvailableHandlePagination,
                                this,
                                true
                            );
                ...
                if (details) {
                    ...
                    for (var i = 0; i < trades.length; i++) {
                        ...
                        nLi.innerHTML = [
                            ...
                            '<img src="',
                            Lib.AssetUrl,
                            'ui/s/essentia.png" class="smallEssentia" />',
                        ].join('');
                        nUl.appendChild(nLi);
                        ...
                        Event.on(
                            bbtn,
                            'click',
                            this.AvailableAccept,
                            { Self: this, Trade: trade, Line: nUl },
                            true
                        );
                        nUl.appendChild(nLi);
            ...
            MineWithdraw: function() {
                if (
                    confirm(
                        [
                            'Are you sure you want to withdraw the trade asking for ',
                            this.Trade.ask,
                            ' essentia and offering ',
                            this.Trade.offer.join(', '),
                            '?',
                        ].join('')
                    )
                ) {
                            ...
                            if (Lang.isArray(resource)) {
                                for (x = 0; x < resource.length; x++) {
                                    ...
                                    if (this.resources[name]) {
                                        ...
                                        nLi.innerHTML = [
                                            '<span class="tradeResourceName">',
                                            name.titleCaps(),
                                            ' (<label class="quantity">',
                                            this.resources[name],
                                            '</label>)</span> <input type="text" style="width:75px;" /><button type="button">+</button>',
                                        ].join('');
                                        elm.appendChild(nLi);
                                    }
                                }
            ...
            AddResource: function(e, matchedEl, container) {
                ...
                if (quantity && c) {
                    ...
                    if (exists.length == 0) {
                        ...
                        var a = new Util.ColorAnim(
                            lq,
                            { color: { from: '#0f0', to: '#fff' } },
                            1.5
                        );
                        a.animate();
                    }
            ...
            AddTrade: function() {
                ...
                if (!Lang.isNumber(qVal) || qVal <= 0) {
                    Dom.get('tradeAddMessage').innerHTML =
                        'Quantity of asking essentia must be a number and greater than 0';
                    return;
                } else {
                    Dom.get('tradeAddMessage').innerHTML = '';
                }
            ...
            SupplyChainList: function() {
                ...
                metric.innerHTML = this.SupplyMetricDescription(
                    supply_chains[0].percent_transferred
                );
                ...
                for (var i = 0; i < supply_chains.length; i++) {
                    ...
                    Event.on(
                        delBtn,
                        'click',
                        this.SupplyChainRemove,
                        { Self: this, Chain: chain, Line: nUl },
                        true
                    );
            ...
            SupplyMetricDescription: function(percent_transferred) {
                ...
                if (percent_transferred == 0) {
                    ...
                    output.push(
                        'Your shipping capacity and supply chains requirements are exactly in sync.'
                    );
                }
                return output.join('');
            },
            ...
            SupplyChainRemove: function() {
                ...
                if (
                    !confirm(
                        [
                            'Are you sure you want to delete the supply chain of',
                            chain.resource_hour,
                            chain.resource_type.titleCaps(),
                            'to',
                            chain.body.name,
                        ].join(' ')
                    )
            ...
            WasteChainDetailsPopulate: function() {
                ...
                if (details) {
                    ...
                    if (
                        Game.GetCurrentPlanet().waste_hour != 0 &&
                    ...
                    details.innerHTML = [
                        ...
                        'Waste/hr: ',
                        '<input id="chainWasteHourInput" type="text" value="',
                        waste_chain.waste_hour,
                        '"/> ',
                        ...
                        show_equalize_button
                            ...
                            : '<br/>',
                        'Percent Transferred: ',
                        waste_chain.percent_transferred,
                        '&#37;',
                        '<hr>',
                    ].join('');

                    Event.on(
                        'chainWasteHourButton',
                        'click',
                        this.WasteChainUpdateWasteHour,
                        { Self: this },
                        true
                    );
                    Event.on(
                        'chainWasteEqualizeButton',
                        'click',
                        this.WasteChainEqualize,
                        { Self: this },
                        true
                    );
                }
