...
if (
    typeof YAHOO.lacuna.buildings.DistributionCenter == 'undefined' ||
    ...
    (function() {
        ...
        Lang.extend(DistributionCenter, Lacuna.buildings.Building, {
            ...
            ReservePopulate: function() {
                ...
                if (announce) {
                    announce.innerHTML = [
                        'You can reserve at most ',
                        Lib.formatNumber(reserve.max_reserve_size),
                        ' resources for ',
                        Lib.formatTime(reserve.max_reserve_duration),
                        '.',
                    ].join('');
                }
                ...
                Dom.setStyle(
                    Sel.query('.distribContainers', 'distribReserveContainers'),
                    'height',
                    Ht + 'px'
                );
            },
