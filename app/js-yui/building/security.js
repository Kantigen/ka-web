...
if (
    ...
    (function() {
        ...
        var Security = function(result) {
            ...
            this.foreignSpiesMessage =
                "There may be spies on your planet that we don't know about.";
        };
                            ...
                            },
                            {
                                success: function(o) {
                                    ...
                                    this.pagerPrisoners.subscribe(
                                        'changeRequest',
                                        this.PrisonersHandlePagination,
                                        this,
                                        true
                                    );
                ...
                if (details) {
                    ...
                    for (var i = 0; i < prisoners.length; i++) {
                        ...
                        Event.on(
                            Ebtn,
                            'click',
                            this.PrisonersExecute,
                            { Self: this, Prisoner: prisoner, Line: nDiv },
                            true
                        );
                        Event.on(
                            Rbtn,
                            'click',
                            this.PrisonersRelease,
                            { Self: this, Prisoner: prisoner, Line: nDiv },
                            true
                        );
                    }
