...
if (
    typeof YAHOO.lacuna.buildings.MercenariesGuild == 'undefined' ||
    !YAHOO.lacuna.buildings.MercenariesGuild
) {
    (function() {
        var Lang = YAHOO.lang,
            Util = YAHOO.util,
        ...
        var MercenariesGuild = function(result) {
            ...
            this.addMercenariesGuildText = [
                'Add for ',
                cost,
                '<img src="',
                Lib.AssetUrl,
                'ui/s/essentia.png" class="smallEssentia" style="vertical-align:middle;" />',
            ].join('');
            ...
            _getAddTab: function() {
                this.add = new YAHOO.widget.Tab({
                    ...
                    content: [
                        ...
                        '</ul></div><button id="tradeAdd" type="button">',
                        this.addMercenariesGuildText,
                        '</button>',
                    ].join(''),
                });
                ...
                if (details) {
                    ...
                    for (var i = 0; i < trades.length; i++) {
                        ...
                        Event.on(
                            ...
                            { Self: this, MercenariesGuild: trade, Line: nUl },
                            true
                        );
                        nUl.appendChild(nLi);
                    ...
                    },
                    {
                        success: function(o) {
                            YAHOO.log(
                                o,
                                'info',
                                'MercenariesGuild.accept_trade.success'
                            );
