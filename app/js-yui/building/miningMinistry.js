    ...
    (function() {
        ...
        Lang.extend(MiningMinistry, Lacuna.buildings.Building, {
            getChildTabs: function() {
                return [
                    this._getPlatformTab(),
                    this._getShipsTab(),
                    this._getAbandonAllPlatformsTab(),
                ];
            },
            ...
            _getAbandonAllPlatformsTab: function() {
                ...
                Event.on(
                    'miningMinistryBigRedButton',
                    'click',
                    this.AbandonAllPlatforms,
                    this,
                    true
                );
            ...
            CapacityDescription: function(capacity) {
                ...
                if (capacity == -1) {
                    ...
                    output.push(
                        'You are producing an insignificant amount of ore. Add more platforms or upgrade your Mining Ministry.'
                    );
                } else if (capacity > 100) {
                    output.push(
                        'You are producing more than your ships can handle. Add more ship to bring the value closer to 100.'
                    );
                } else if (capacity < 100) {
                    output.push(
                        'Your ships have more capacity than the platforms are producing. You may remove ships or add platforms to get closer to 100.'
                    );
                } else if (capacity == 100) {
                    output.push(
                        'Your shipping capacity and production values are exactly in sync.'
                    );
                }
                return output.join('');
            },
                    ...
                    if (platforms.length > 0) {
                        for (var i = 0; i < platforms.length; i++) {
                            ...
                            Event.on(
                                bbtn,
                                'click',
                                this.MiningMinistryPlatformAbandon,
                                { Self: this, Platform: obj, Line: nUl },
                                true
                            );
                        }
            ...
            MiningMinistryPlatformAbandon: function() {
                if (
                    confirm(
                        [
                            'Are you sure you want to Abandon the mining platform at  ',
                            this.Platform.asteroid.name,
                            '?',
                        ].join('')
                    )
                ) {
                    ...
                    for (var i = 0; i < ships.length; i++) {
                        ...
                        if (ship.task == 'Docked') {
                            ...
                            Event.on(
                                bbtn,
                                'click',
                                this.MiningMinistryShipsRemove,
                                { Self: this, Ship: ship },
                                true
                            );
                        }
