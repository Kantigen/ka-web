...
if (
    typeof YAHOO.lacuna.buildings.Intelligence == 'undefined' ||
        ...
        Lang.extend(Intelligence, Lacuna.buildings.Building, {
            ...
            _getTrainTab: function() {
                ...
                this.trainTab = new YAHOO.widget.Tab({
                    ...
                    content: [
                        ...
                        '        <ul>',
                        '            <li><span style="font-weight:bold;">Spies:</span> <span id="spiesCurrent">',
                        spies.current,
                        '</span> of ',
                        spies.maximum,
                        '</li>',
                        ...
                        Lib.AssetUrl,
                        'ui/s/food.png" title="Food" class="smallFood" /></span><span class="buildingDetailsNum">',
                        spies.training_costs.food,
                        '</span></li>',
                        '            <li><span class="smallImg"><img src="',
                        Lib.AssetUrl,
                        'ui/s/ore.png" title="Ore" class="smallOre" /></span><span class="buildingDetailsNum">',
                        spies.training_costs.ore,
                        '</span></li>',
                        '            <li><span class="smallImg"><img src="',
                        Lib.AssetUrl,
                        'ui/s/water.png" title="Water" class="smallWater" /></span><span class="buildingDetailsNum">',
                        spies.training_costs.water,
                        '</span></li>',
                        '            <li><span class="smallImg"><img src="',
                        Lib.AssetUrl,
                        'ui/s/energy.png" title="Energy" class="smallEnergy" /></span><span class="buildingDetailsNum">',
                        spies.training_costs.energy,
                        '</span></li>',
                        '            <li><span class="smallImg"><img src="',
                        Lib.AssetUrl,
                        'ui/s/waste.png" title="Waste" class="smallWaste" /></span><span class="buildingDetailsNum">',
                        spies.training_costs.waste,
                        '</span></li>',
                        '            <li><span class="smallImg"><img src="',
                        Lib.AssetUrl,
                        'ui/s/time.png" title="Time" class="smallTime" /></span><span class="buildingDetailsNum">',
                        Lib.formatTime(spies.training_costs.time),
                        '</span></li>',
                        '        </ul>',
                        '    </div>',
                        '</div>',
            ...
            _getSpiesTab: function() {
                this.spiesTab = new YAHOO.widget.Tab({
                    ...
                    content: [
                        '<div>',
                        '    <p id="spiesSubsidizeOffer" style="display:none;">You may subsidize training for 1 <img src="',
                        Lib.AssetUrl,
                        'ui/s/essentia.png" class="smallEssentia" /> per spy. <button type="button" id="spiesSubsidize">Subsidize</button></p>',
                        '    <div>',
                        '        <div id="spiesDetails">',
                        '        </div>',
                        '    </div>',
            ...
            SpyInfo: function(spy) {
                ...
                nLi.innerHTML =
                    '<label>Assigned To:</label> <a class="starmap_link" href="#' +
                    spy.assigned_to.x +
                    'x' +
                    spy.assigned_to.y +
                    '">' +
                ...
                if (
                    ...
                    for (var a = 0; a < assign.length; a++) {
                        ...
                        nOpt.innerHTML = [
                            job.task,
                            ' - Skill: ',
                            job.skill.titleCaps('_', ''),
                            ' - Recovery: ',
                            Lib.formatTime(job.recovery),
                        ].join('');
                    ...
                    Event.on(
                        ...
                        'click',
                        this.SpyAssign,
                        { Self: this, Assign: sel, Id: spy.id, Line: nDiv },
                        true
                    );
                    ...
                    this.Self.service.burn_spy(
                        ...
                        },
                        {
                            success: function(o) {
                                ...
                                this.Self.result.spies.current =
                                    this.Self.result.spies.current * 1 - 1;
                            },
                            scope: this,
                        }
                    );
                    ...
                    this.service.train_spy(
                        ...
                        },
                        {
                            success: function(o) {
                                ...
                                if (
                                    not_trained > 0 &&
                                    o.result.reason_not_trained &&
                                    o.result.reason_not_trained.message
                                ) {
