    ...
    (function() {
        ...
        var CreateEmpire = function(Login) {
            ...
            container.innerHTML = [
                ...
                '                    <li class="empireCaptcha"><span id="empireCaptchaBorder"><img alt="" width="300" height="80" src="" id="empireCaptchaImage" /></span><button id="empireRefreshCaptcha" type="button"><img alt="Refresh" src="' +
                    Lib.AssetUrl +
                    'ui/s/refresh.png" /></button></li>',
            ...
            this.Dialog.cfg.queueProperty(
                'keylisteners',
                new YAHOO.util.KeyListener(
                    'empirePassConfirm',
                    { keys: 13 },
                    { fn: this.handleCreate, scope: this, correctScope: true }
                )
            );
            this.Dialog.render();
        ...
        CreateEmpire.prototype = {
            ...
            handleCreate: function() {
                if (!this.elAgreeTOS.checked || !this.elAgreeRules.checked) {
                    this.setMessage(
                        'You must agree to the Terms of Service and the rules before registering.'
                    );
                    return;
                }
                this.setMessage('');
