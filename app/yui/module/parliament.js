  ...
  (function () {
    ...
    Lang.extend(Parliament, Lacuna.buildings.Building, {
      ...
      _getCreateTab: function () {
        ...
        if (getAllianceMembers) {
          Game.Services.Alliance.view_profile(
            {
              session_id: Game.GetSession(),
              alliance_id: BodyRPCStore.alliance.id,
            },
            {
              success: function (o) {
      ...
      ProposeWritTemplateChange: function () {
        var opt =
          Game.Resources.writ_templates[Lib.getSelectedOption('proposeWritTemplates').value];
              ...
              success: function (o) {
                ...
                for (var i = 0; i < platforms.length; i++) {
                  ...
                  optionValues[optionValues.length] =
                    '<option value="' + platform.id + '">' + platform.empire.name + '</option>';
                }
