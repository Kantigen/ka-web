      ...
      _getCoverageTab: function () {
        this.coverageTab = new YAHOO.widget.Tab({
          ...
          content: [
            ...
            '    <span id="newsCoverageText">',
            this.result.restrict_coverage == '1'
              ? 'Coverage is current restricted'
              : 'News is flowing freely',
            '</span>',
            '    : <button id="newsCoverage" type="button">',
            this.result.restrict_coverage == '1' ? 'Open Coverage' : 'Restrict Coverage',
            '</button>',
            '</div>',
                ...
                for (var key in rss) {
                  if (rss.hasOwnProperty(key)) {
                    ...
                    rssLi.innerHTML = [
                      ...
                      Lib.AssetUrl,
                      'ui/rss.png" alt="rss" style="margin-left:1px" /></a>',
                    ].join('');
