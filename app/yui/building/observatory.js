...
if (
  typeof YAHOO.lacuna.buildings.Observatory == 'undefined' ||
  !YAHOO.lacuna.buildings.Observatory
) {
  (function () {
    var Lang = YAHOO.lang,
      Util = YAHOO.util,
    ...
    Lang.extend(Observatory, Lacuna.buildings.Building, {
      ...
      ProbeAbandon: function (e, matchedEl, container) {
        if (container.Star) {
          if (
            confirm(
              ['Are you sure you want to abandon the probe at ', container.Star.name, '?'].join('')
            )
          ) {
            MenuStore.showLoader();
      ...
      AbandonAllProbes: function (e) {
        if (
          confirm('Are you sure you want to abandon all probes controlled by this Observatory?')
        ) {
          MenuStore.showLoader();
