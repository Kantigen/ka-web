    ...
    Lang.extend(PlanetaryCommand, Lacuna.buildings.Building, {
      ...
      _getPlanetTab: function () {
        ...
        var details = function (type, imgclass) {
          ...
          return [
            ...
            imgclass,
            '" /></span>',
            '    <span class="pcStored" title="',
            Lib.formatNumber(stored),
            '">',
            util.reduceNumber(stored),
            '</span>',
            capacity
              ? [
                  '    <span class="pcSlash">/</span>',
                  '    <span class="pcCapacity" title="',
                  Lib.formatNumber(capacity),
                  '">',
                  util.reduceNumber(capacity),
                  '</span>',
                ].join('')
              : ['<span class="pcSlash">&nbsp;</span><span class="pcCapacity">&nbsp;</span>'].join(
                  ''
                ),
            '  @ <span class="pcPerHour" title="',
            Lib.formatNumber(perhour),
            '">',
            util.reduceNumber(perhour),
            '/hr</span></li>',
          ].join('');
        };
        var tab = new YAHOO.widget.Tab({
          ...
          content: [
            ...
            '            <li><label>Buildings:</label>',
            planet.building_count,
            '</li>',
            '            <li><label>Planet Size:</label>',
            planet.size,
            '</li>',
            '            <li><label>Plots Available:</label>',
            (planet.plots_available || 0) * 1,
            '</li>',
            '            <li><label>Population:</label>',
      ...
      _getRenameTab: function () {
        this.renameTab = new YAHOO.widget.Tab({
          ...
          content: [
            '<div><ul>',
            '    <li><label>Current Planet Name: </label><span id="commandPlanetCurrentName">',
            BodyRPCStore.name,
            '</span></li>',
      ...
      _getNotesTab: function () {
        ...
        this.notesTab = new YAHOO.widget.Tab({
          ...
          content: [
            '<div id="pccNotes">',
            '    <textarea id="pccNotesText" title="Write down anything you would like to store with this body.">',
            $('<div/>')
              .text(notes ? notes : '')
              .html(),
            '</textarea>',
