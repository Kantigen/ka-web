...
if (
  ...
  !YAHOO.lacuna.buildings.FoodReserve
) {
  (function () {
    var Util = YAHOO.util,
      Dom = Util.Dom,
    ...
    YAHOO.lang.extend(FoodReserve, YAHOO.lacuna.buildings.Building, {
      ...
      _foodDetails: function (info) {
        return [
          ...
          '</label><span class="buildingDetailsNum">',
          info.amount,
          '</span></li>',
        ].join('');
      },
      _getFoodTab: function () {
        ...
        var details = function (type) {
          return [
            '<li title="',
            Lib.formatNumber(stored[type]),
            '"><label>',
            Lib.capitalizeFirstLetter(type),
            '</label><span class="buildingDetailsNum">',
            util.reduceNumber(stored[type], 1),
            '</span></li>',
          ].join('');
        };
      ...
      DumpGetDisplay: function () {
        ...
        if (resources.length > 0) {
          ...
          nLi.innerHTML =
            ...
            Lib.AssetUrl +
            'ui/s/food.png" class="smallFood" /></span>';
                ...
                success: function (o) {
                  ...
                  if (this.dumpTab) {
                    ...
                    Dom.get('dumpMessage').innerHTML =
                      'Successfully converted ' + amount + ' ' + type + ' to waste.';
                    Lib.fadeOutElm('dumpMessage');
                  }
