...
if (
  typeof YAHOO.lacuna.buildings.WasteExchanger == 'undefined' ||
  !YAHOO.lacuna.buildings.WasteExchanger
) {
  (function () {
    var Lang = YAHOO.lang,
      Util = YAHOO.util,
    ...
    Lang.extend(WasteExchanger, Lacuna.buildings.Building, {
                ...
                success: function (o) {
                  ...
                  if (this.recycleTab) {
                    ...
                    if (
                      ...
                      ce.appendChild(
                        this.RecycleGetTimeDisplay(o.result.recycle, water, ore, energy)
                      );
                      this.addQueue(
                        this.work.seconds_remaining,
                        this.RecycleQueue,
                      ...
                      this.recycleMessageEl.innerHTML =
                        'Successfully recycled ' + Lib.formatNumber(total) + ' waste.';
                    }
                  }
                },
                scope: this,
      ...
      RecycleGetDisplay: function (recycle) {
        ...
        nLi.innerHTML =
          ...
          Lib.AssetUrl +
          'ui/s/ore.png" class="smallOre" /></span>';
        ...
        nLi.innerHTML =
          '<span class="smallImg"><img src="' +
          Lib.AssetUrl +
          'ui/s/energy.png" class="smallEnergy" /></span>';
        input = document.createElement('input');
        ...
        label.innerHTML =
          ...
          Lib.AssetUrl +
          'ui/s/time.png" class="smallTime" title="Time" /></span>';
        ...
        if (EmpireRPCStore.essentia >= 2) {
          ...
          fieldset.innerHTML =
            ...
            Lib.AssetUrl +
            'ui/s/essentia.png" class="smallEssentia" title="Essentia" /></span>2</label>';
          btn = document.createElement('button');
          btn.setAttribute('type', 'button');
      ...
      RecycleGetTimeDisplay: function (recycle, water, ore, energy) {
        ...
        div.innerHTML = [
          '<p>Current recycling job:</p>',
          '<ul><li><span class="smallImg"><img src="',
          Lib.AssetUrl,
          'ui/s/ore.png" class="smallOre" /></span>',
          recycle.ore || ore || '',
          '</li>',
          ...
          Lib.AssetUrl,
          'ui/s/energy.png" class="smallEnergy" /></span>',
          recycle.energy || energy || '',
          '</li>',
          '<li><span class="smallImg"><img src="',
          Lib.AssetUrl,
          'ui/s/time.png" class="smallTime" /></span><span id="recycleTime">',
          Lib.formatTime(recycle.seconds_remaining),
          '</span></li></ul>',
        ].join('');

        btnDiv.appendChild(
          document.createTextNode(
            'You may subsidize the recycle job for 2 essentia and finish it immediately. '
          )
        );
