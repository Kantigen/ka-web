        ...
        if (this.EmpireTable) {
          ...
          this.EmpireTable.set('generateRequest', function (oState, oSelf) {
            ...
            var sort = encodeURIComponent(
                oState.sortedBy ? oState.sortedBy.key : oSelf.getColumnSet().keys[0].getKey()
              ),
              dir =
                oState.sortedBy && oState.sortedBy.dir === YAHOO.widget.DataTable.CLASS_DESC
                  ? 'desc'
                  : 'asc',
        ...
        oTextboxList.generateRequest = function (sQuery) {
          var state = Lacuna.Stats.EmpireTable.getState(),
            s = Lang.JSON.stringify({
              ...
              jsonrpc: '2.0',
              params: [Game.GetSession(''), state.sortedBy + '_rank', decodeURIComponent(sQuery)],
            });
          return s;
        };
