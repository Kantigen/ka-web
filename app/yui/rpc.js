  ...
  (function () {
    ...
    Service.prototype = {
      ...
      _generateService: function (serviceName, method) {
        if (this[method]) {
          throw new Error(
            'WARNING: ' + serviceName + ' already exists for service. Unable to generate function'
          );
        }
    ...
    YAHOO.rpc.Transport = {
      ...
      JSONP: function (r) {
        ...
        YAHOO.rpc.Transport.JSONP['jsonpCallback' + YAHOO.rpc.Transport.jsonp_id] = function (
          results
        ) {
          ...
          if (
            ...
            if (results.status == -1) {
              ...
              return {
                error: {
                  message:
                    'Communication with the server has been interrupted for an unknown reason.',
                },
              };
            } else {
