  ...
  (function () {
    ...
    var TBL = function (elInput, oDataSource, oConfigs) {
      ...
      oConfigs.formatResultColumnKeys = oConfigs.formatResultColumnKeys || [
        oDataSource.responseSchema.fields[0].key || oDataSource.responseSchema.fields[0],
          ...
          if (queue) {
            for (var i = 0; i < allListItemEls.length; i++) {
              ...
              if (
                ...
                queue.indexOf(String(elListItem._oResultData.Id)) >= 0
              ) {
        ...
        if (ok && !oResponse.error) {
          ...
          if (nItemsToShow > 0) {
            ...
            for (var i = nItemsToShow - 1; i >= 0; i--) {
              ...
              elListItem._sResultMatch = YAHOO.lang.isString(oResult)
                ? oResult
