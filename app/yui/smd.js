        ...
        var smd = {
            ...
            Body: {
                ...
                services: {
                    abandon: {
                        description:
                            "Abandon's a colony, and destroys everything on the planet.",
                        parameters: [
                            {
                                name: 'session_id',
                                type: 'string',
                    ...
                    get_body_status: {
                        description:
                            'Retrieves the status of a body to display in the star map.',
                        parameters: {
                            session_id: { type: 'string', optional: false },
                            body_id: { type: 'string', optional: false },
                        },
            ...
            Buildings: {
                Generic: {
                    ...
                    services: {
                        ...
                        downgrade: {
                            description:
                                'Downgrades a building by one level and then returns view.',
                            parameters: [
                                {
                                    name: 'session_id',
                                    type: 'string',
                ...
                Archaeology: {
                    ...
                    services: {
                        ...
                        assemble_glyphs: {
                            description:
                                'Turns glyphs into rare ancient items.',
                            parameters: [
                                {
                                    name: 'session_id',
                                    type: 'string',
                        ...
                        */
                        ...
                        mass_abandon_excavator: {
                            description:
                                'Close down all existing excavator sites.',
                            parameters: [
                                {
                                    name: 'session_id',
                                    type: 'string',
                ...
                BlackHoleGenerator: {
                    ...
                    services: {
                        ...
                        subsidize_cooldown: {
                            description:
                                'Will spend 2 essentia to cool down the BHG immediately.',
                            parameters: [
                                {
                                    name: 'session_id',
                                    type: 'string',
                ...
                Development: {
                    ...
                    services: {
                        subsidize_one_build: {
                            description:
                                'Instantly finish any one building on the build queue.',
                            parameters: [
                                {
                                    name: 'args',
                                    type: 'object',
                        ...
                        cancel_build: {
                            description:
                                'Cancel any one building on the build queue.',
                            parameters: [
                                {
                                    name: 'args',
                                    type: 'object',
                        ...
                        assign_spy: {
                            ...
                            parameters: [
                                ...
                                },
                                {
                                    ...
                                    type: 'string',
                                    optional: false,
                                }, // "Idle", "Counter Intelligence", "Sting"
                            ],
                            returns: { type: 'object' },
                        },
                        name_spy: {
                    ...
                    services: {
                        ...
                        */
                        ...
                        mass_abandon_platform: {
                            description:
                                'Close down all existing mining platforms.',
                            parameters: [
                                {
                                    name: 'session_id',
                                    type: 'string',
                ...
                Observatory: {
                    ...
                    services: {
                        ...
                        abandon_all_probes: {
                            description:
                                'All probes are deactivated, and allowed to burn up in the stars.',
                            parameters: [
                                {
                                    name: 'session_id',
                                    type: 'string',
                ...
                Park: {
                    ...
                    services: {
                        ...
                        subsidize_party: {
                            description:
                                'Will spend 2 essentia to complete the current party immediately.',
                            parameters: [
                                {
                                    name: 'session_id',
                                    type: 'string',
                ...
                Shipyard: {
                    ...
                    services: {
                        ...
                        subsidize_ship: {
                            description:
                                'Will spend 1 essentia to build the ship immediately.',
                            parameters: [
                                {
                                    name: 'args',
                                    type: 'object',
                        ...
                        build_ship: {
                            ...
                            parameters: [
                                ...
                                },
                                {
                                    ...
                                    type: 'string',
                                    optional: false,
                                }, //'probe','colony_ship','spy_pod','cargo_ship','space_station','smuggler_ship','mining_platform_ship','terraforming_platform_ship', or 'gas_giant_settlement_ship'
                                {
                                    name: 'quantity',
                                    type: 'number',
                                    optional: false,
                ...
                SpacePort: {
                    ...
                    services: {
                        ...
                        */
                        ...
                        send_ship: {
                            description:
                                'Sends a ship to a specified body or star. Use with get_ships_for.',
                            parameters: [
                                {
                                    name: 'session_id',
                                    type: 'string',
            ...
            Empire: {
                ...
                services: {
                    ...
                    */
                    ...
                    edit_profile: {
                        description:
                            'Edits properties of an empire. Returns the get_own_profile method. See also the get_own_profile and view_public_profile  methods.',
                        parameters: {
                            session_id: { type: 'string', optional: false },
                            profile: { type: 'object', optional: false },
                        },
                        returns: { type: 'object' },
                    },
                    view_public_profile: {
                    ...
                    */
                    ...
                    reset_password: {
                        description:
                            'Changes the empire password that has been forgotten.',
                        parameters: [
                            {
                                name: 'reset_key',
                                type: 'string',
            ...
            Inbox: {
                ...
                */
                    ...
                    view_archived: {
                        description:
                            "Displays a list of the messages in the empire's archive.",
                        parameters: [
                            {
                                name: 'session_id',
                                type: 'string',
                    ...
                    view_trashed: {
                        description:
                            "Displays a list of the messages in the empire's trash.",
                        parameters: [
                            {
                                name: 'session_id',
                                type: 'string',
                    ...
                    view_unread: {
                        description:
                            "Displays a list of the unread messages in the empire's inbox.",
                        parameters: [
                            {
                                name: 'session_id',
                                type: 'string',
                    ...
                    view_sent: {
                        description:
                            "Displays a list of the messages in the empire's outbox.",
                        parameters: [
                            {
                                name: 'session_id',
                                type: 'string',
            ...
            Map: {
                ...
                services: {
                    ...
                    */
                    ...
                    get_star_map: {
                        description:
                            'Retrieves a chunk of the star map (lite version).',
                        parameters: [
            ...
            Stats: {
                ...
                services: {
                    ...
                    */
                    ...
                    find_empire_rank: {
                        description:
                            'Search for a particular empire in the empire_rank().',
                        parameters: [
                            {
                                name: 'session_id',
                                type: 'string',
                            ...
                            },
                            {
                                ...
                                type: 'string',
                                optional: false,
                            }, //Must be at least 3 characters to search.
                        ],
                        returns: { type: 'object' },
                        /*
                     {
